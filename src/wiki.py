...
elif aDire == ("jean racine"):
  print("Jean Racine (La Ferté-Milon, 22 décembre 1639 - Paris, 21 avril 1699) est un dramaturge et poète français, considéré comme l'un des plus grands auteurs de tragédies de la période classique en France.")
elif aDire == ("leonardo dicaprio"):
  print("Leonardo DiCaprio, né le 11 novembre 1974 à Los Angeles, est un acteur, scénariste et producteur de cinéma américain.")
elif aDire == ("charlie chaplin"):
  print("Charles Spencer Chaplin, dit Charlie Chaplin (né le 16 avril 1889 à Londres - 25 décembre 1977 à Corsier-sur-Vevey), est un acteur, réalisateur, scénariste, producteur et compositeur britannique qui devint une idole du cinéma muet grâce à son personnage de Charlot. Durant une carrière qui ne dura pas moins de 65 ans, il joua dans plus de 80 films, et sa vie publique et privée a fait l'objet d'adulation comme de controverses.")
elif aDire == ("morgan freeman"):
  print("Morgan Freeman, né le 1er juin 1937 à Memphis (Tennessee), est un acteur américain.Ayant commencé sa carrière théâtrale et cinématographique en 1964, il fut habitué aux seconds rôles pendant plus de vingt ans. Il acquiert une large reconnaissance internationale après avoir été nommé aux Oscars pour La Rue en 1987, Miss Daisy et son chauffeur en 1989, Les Évadés en 1994 et Invictus en 2009 ; il a par ailleurs reçu l'Oscar du meilleur acteur dans un second rôle pour Million Dollar Baby en 2004.")
elif aDire == ("marlo brando"):
  print("Marlon Brando, Jr., né le 3 avril 1924 à Omaha et décédé le 1er juillet 2004 à Los Angeles, est un acteur et réalisateur qui est considéré comme l'un des acteurs américains les plus grands et les plus influents du XXe siècle. L'American Film Institute l'a classé ""quatrième acteur de légende du cinéma américain"".")    
elif aDire == ("angelina jolie"):
  print("Angelina Jolie, née Angelina Jolie Voight le 4 juin 1975 à Los Angeles, est une actrice, réalisatrice, scénariste, productrice, mannequin, philanthrope, écrivaine et ambassadrice de bonne volonté américano-cambodgienne. Elle a reçu trois Golden Globes, deux Screen Actors Guild Awards et un Oscar du cinéma. Selon le magazine Forbes Angelina Jolie est l'actrice la mieux payée d'Hollywood entre juin 2012 et juin 2013.")
elif aDire == ("louis de funes"):
  print("Louis de Funès de Galarza, dit Louis de Funès, est un acteur français né le 31 juillet 1914 à Courbevoie et mort le 27 janvier 1983 à Nantes")
elif aDire == ("will smith"):
  print("Will Smith, de son nom complet Willard Christopher Smith, Jr., est un acteur, producteur et chanteur de hip-hop américain, né le 25 septembre 1968 à Philadelphie")
elif aDire == ("gerard jugnot"):
  print("Gérard Jugnot est un acteur, réalisateur, scénariste et producteur français né le 4 mai 1951 à Paris.")
elif aDire == ("alain delon"):
  print("Alain Delon, né le 8 novembre 1935 à Sceaux (Hauts-de-Seine), est un acteur et homme d'affaires français ; il a également la nationalité suisse depuis 1999")
elif aDire == ("john travolta"):
  print("John Travolta est un acteur, chanteur, danseur et producteur de cinéma américain né le 18 février 1954 à Englewood (New Jersey).")
elif aDire == ("gerard "):
  print("Julio Gerardo Hernández dit Gérard Hernandez, né le 20 janvier 1933 à Valladolid, est un acteur français d'origine espagnole naturalisé en 1975")
elif aDire == ("guillaume pley"):
  print("Guillaume Pley est un animateur de radio et un présentateur de télévision française, né le 26 juillet 1985 à Sainte-Adresse en Seine-Maritime.")
elif aDire == ("lesage"):
  print("Alain-René Lesage ou Le Sage, né à Sarzeau le 8 mai 1668 et mort à Boulogne-sur-Mer le 17 novembre 1747, est un romancier et auteur dramatique français surtout connu comme étant l'auteur du roman picaresque Histoire de Gil Blas de Santillane.")    
else:
